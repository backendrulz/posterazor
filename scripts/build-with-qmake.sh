...
./linuxdeploy-x86_64.AppImage --appdir AppDir -e PosteRazor -i "$REPO_ROOT"/resources/posterazor.png -d "$REPO_ROOT"/resources/posterazor.desktop --plugin qt --output appimage

# move built AppImage back into original CWD
mv PosteRazor*.AppImage "$OLD_CWD"